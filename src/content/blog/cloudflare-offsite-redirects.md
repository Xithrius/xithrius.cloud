...
![Menu Dropdown](/images/blog/cloudflare-offsite-redirects/menu-dropdown.png)
...
![Menu Dropdown](/images/blog/cloudflare-offsite-redirects/dns-record.png)

and the page rule's listing should be of relative calibar to the image below.

![Menu Dropdown](/images/blog/cloudflare-offsite-redirects/page-rule.png)
