...
<template>
  <div class="relative w-full p-4 overflow-hidden bg-white border dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex justify-between border-b dark:border-gray-700">
      ...
      <div>
        <button type="button" class="px-2 pb-2 dark:text-white" @click="clearData">
          Clear
        </button>
      </div>
    </div>
    ...
    <div v-auto-animate class="relative w-full">
      ...
      <template v-if="signatureData.type === 'draw'">
        <div class="absolute w-full h-px bg-gray-300 dark:bg-gray-700 bottom-8" />
        <div
        ...
        >
          <p class="text-5xl text-gray-300 dark:text-gray-600 font-signature">
            Draw Signature Here
          </p>
        </div>
        <div class="z-10">
